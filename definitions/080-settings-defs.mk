...
# Other VS Code stuff?
VS_CODE_SETTINGS_DEPS += $(shell find $(ALL_VSCODE_SHARED_SETTINGS) $(PYTHON_PROJECT_SETTINGS) -maxdepth 1 -name 'settings.json' 2> /dev/null)
VS_CODE_LAUNCH_DEPS += $(shell find $(ALL_VSCODE_SHARED_SETTINGS) $(PYTHON_PROJECT_SETTINGS) -maxdepth 1 -name 'launch.json' 2> /dev/null)
